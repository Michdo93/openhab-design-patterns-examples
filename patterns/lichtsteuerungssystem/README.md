...
Kombiniertes Lichtsteuerungssystem: zeitgesteuerte Helligkeit, Bewegungsaktivierung, dynamische Tageszeit-Anpassung.

## Dateien in diesem Beispiel

**Items** (`items/`):
- `lichtsteuerungssystem.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `lichtsteuerungssystem-bewegung.rules`, `lichtsteuerungssystem-dynamisch.rules`, `lichtsteuerungssystem-zeit.rules`
- JavaScript Scripting (`rules-js/`): `lichtsteuerungssystem-bewegung.js`, `lichtsteuerungssystem-dynamisch.js`, `lichtsteuerungssystem-zeit.js`
- Python 3 Scripting (`rules-python/`): `lichtsteuerungssystem_bewegung.py`, `lichtsteuerungssystem_dynamisch.py`, `lichtsteuerungssystem_zeit.py`
