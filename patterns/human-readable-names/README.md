...
- Rules DSL (`rules-dsl/`): `human-readable-names-complex.rules`, `human-readable-names-simple.rules`
- JavaScript Scripting (`rules-js/`): `human-readable-names-complex.js`, `human-readable-names-simple.js`
- Python 3 Scripting (`rules-python/`): `human_readable_names_complex.py`, `human_readable_names_simple.py`
