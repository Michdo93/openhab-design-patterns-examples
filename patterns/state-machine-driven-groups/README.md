...
**Items** (`items/`):
- `state-machine-driven-groups-complex.items`
- `state-machine-driven-groups-simple.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `state-machine-driven-groups-complex.rules`, `state-machine-driven-groups-simple.rules`
- JavaScript Scripting (`rules-js/`): `state-machine-driven-groups-complex.js`, `state-machine-driven-groups-simple.js`
- Python 3 Scripting (`rules-python/`): `state_machine_driven_groups_complex.py`, `state_machine_driven_groups_simple.py`
