...
Zeitstempel-basierte Entprellung/Latching einer Regel.

## Dateien in diesem Beispiel

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `rule-verriegelung.rules`
- JavaScript Scripting (`rules-js/`): `rule-verriegelung.js`
- Python 3 Scripting (`rules-python/`): `rule_verriegelung.py`
