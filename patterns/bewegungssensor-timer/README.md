...
**Items** (`items/`):
- `bewegungssensor-timer-expire.items`
- `bewegungssensor-timer-gruppe.items`
- `bewegungssensor-timer.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `bewegungssensor-timer-expire.rules`, `bewegungssensor-timer-gruppe.rules`, `bewegungssensor-timer.rules`
- JavaScript Scripting (`rules-js/`): `bewegungssensor-timer-gruppe.js`, `bewegungssensor-timer.js`
- Python 3 Scripting (`rules-python/`): `bewegungssensor_timer.py`, `bewegungssensor_timer_gruppe.py`
