...
**Items** (`items/`):
- `mqtt-state-supervision.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `mqtt-state-supervision.rules`
- JavaScript Scripting (`rules-js/`): `mqtt-state-supervision.js`
- Python 3 Scripting (`rules-python/`): `mqtt_state_supervision.py`, `supervision.py`
