...
**Items** (`items/`):
- `generic-is-alive.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `generic-is-alive.rules`
- JavaScript Scripting (`rules-js/`): `generic-is-alive.js`
- Python 3 Scripting (`rules-python/`): `generic_is_alive.py`
