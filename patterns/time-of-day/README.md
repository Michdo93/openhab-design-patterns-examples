...
Tageszeit-Zustandsautomat (String-Item vTimeOfDay) auf Basis einer Zeitfenster-Tabelle.
...
- Rules DSL (`rules-dsl/`): `time-of-day.rules`
- JavaScript Scripting (`rules-js/`): `time-of-day.js`
- Python 3 Scripting (`rules-python/`): `time_of_day.py`
