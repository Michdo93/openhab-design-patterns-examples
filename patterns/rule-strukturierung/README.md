...
**Items** (`items/`):
- `rule-strukturierung-gruppe.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `rule-strukturierung-gruppe.rules`, `rule-strukturierung.rules`
- JavaScript Scripting (`rules-js/`): `rule-strukturierung-gruppe.js`, `rule-strukturierung.js`
- Python 3 Scripting (`rules-python/`): `rule_strukturierung.py`, `rule_strukturierung_gruppe.py`
