...
- Rules DSL (`rules-dsl/`): `switch-dimmer-light.rules`, `switch-dimmer.rules`
- JavaScript Scripting (`rules-js/`): `switch-dimmer-light.js`, `switch-dimmer.js`
- Python 3 Scripting (`rules-python/`): `switch_dimmer.py`, `switch_dimmer_light.py`
