...
Bayessche Sensor-Aggregation: mehrere unsichere Beobachtungen zu einer Wahrscheinlichkeit kombinieren (Schlaferkennung).
...
- Rules DSL (`rules-dsl/`): `bayes.rules`
- JavaScript Scripting (`rules-js/`): `bayes.js`
- Python 3 Scripting (`rules-python/`): `bayes.py`
