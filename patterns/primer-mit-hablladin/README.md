...
**Items** (`items/`):
- `primer-mit-hablladin.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `primer-mit-hablladin-door.rules`, `primer-mit-hablladin-manual.rules`, `primer-mit-hablladin.rules`
- JavaScript Scripting (`rules-js/`): `primer-mit-hablladin-door.js`, `primer-mit-hablladin-manual.js`, `primer-mit-hablladin.js`
- Python 3 Scripting (`rules-python/`): `primer_mit_hablladin.py`, `primer_mit_hablladin_door.py`, `primer_mit_hablladin_manual.py`
