...
**Items** (`items/`):
- `debounce-simple.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `debounce-generic.rules`, `debounce-simple.rules`
- JavaScript Scripting (`rules-js/`): `debounce-generic.js`, `debounce-simple.js`
- Python 3 Scripting (`rules-python/`): `debounce_generic.py`, `debounce_simple.py`
