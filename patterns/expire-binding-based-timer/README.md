...
**Items** (`items/`):
- `expire-binding-based-timer-reset.items`
- `expire-binding-based-timer.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `expire-binding-based-timer-reset.rules`, `expire-binding-based-timer.rules`
- JavaScript Scripting (`rules-js/`): `expire-binding-based-timer-reset.js`, `expire-binding-based-timer.js`
- Python 3 Scripting (`rules-python/`): `expire_binding_based_timer.py`, `expire_binding_based_timer_reset.py`
