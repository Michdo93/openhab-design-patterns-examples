...
**Items** (`items/`):
- `watering-system.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `watering-system-trigger.rules`, `watering-system.rules`
- JavaScript Scripting (`rules-js/`): `watering-system-trigger.js`, `watering-system.js`
- Python 3 Scripting (`rules-python/`): `watering_system.py`, `watering_system_trigger.py`
