...
**Items** (`items/`):
- `kaskadierende-timer.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `kaskadierende-timer.rules`
- JavaScript Scripting (`rules-js/`): `kaskadierende-timer.js`
- Python 3 Scripting (`rules-python/`): `kaskadierende_timer.py`
