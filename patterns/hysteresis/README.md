...
Pufferzone um einen Schwellwert, um Flattern beim Schalten zu vermeiden.

## Dateien in diesem Beispiel

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `hysteresis.rules`
- JavaScript Scripting (`rules-js/`): `hysteresis.js`
- Python 3 Scripting (`rules-python/`): `hysteresis.py`
