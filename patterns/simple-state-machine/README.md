...
- Rules DSL (`rules-dsl/`): `simple-state-machine.rules`
- JavaScript Scripting (`rules-js/`): `simple-state-machine.js`
- Python 3 Scripting (`rules-python/`): `simple_state_machine.py`
