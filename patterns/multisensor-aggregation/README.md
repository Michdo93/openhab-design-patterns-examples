...
**Items** (`items/`):
- `multisensor-aggregation.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `multisensor-aggregation-bayes.rules`, `multisensor-aggregation.rules`
- JavaScript Scripting (`rules-js/`): `multisensor-aggregation-bayes.js`, `multisensor-aggregation.js`
- Python 3 Scripting (`rules-python/`): `multisensor_aggregation.py`, `multisensor_aggregation_bayes.py`
