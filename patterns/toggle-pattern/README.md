...
- Rules DSL (`rules-dsl/`): `toggle-pattern-feedback.rules`, `toggle-pattern.rules`
- JavaScript Scripting (`rules-js/`): `toggle-pattern-feedback.js`, `toggle-pattern.js`
- Python 3 Scripting (`rules-python/`): `toggle_pattern.py`, `toggle_pattern_feedback.py`
