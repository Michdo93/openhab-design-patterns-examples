...
- Rules DSL (`rules-dsl/`): `notifications-in-groups.rules`
- JavaScript Scripting (`rules-js/`): `notifications-in-groups.js`
- Python 3 Scripting (`rules-python/`): `notifications_in_groups.py`
