...
**Items** (`items/`):
- `gate-keeper-proxy.items`
- `gate-keeper.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `gate-keeper.rules`
- JavaScript Scripting (`rules-js/`): `gate-keeper.js`
- Python 3 Scripting (`rules-python/`): `gate_keeper.py`
