...
**Items** (`items/`):
- `aufgeschobene-automatisierte-aktionen.items`

**Regeln** – bitte nur EINE der drei Varianten verwenden:

- Rules DSL (`rules-dsl/`): `aufgeschobene-automatisierte-aktionen-example.rules`, `aufgeschobene-automatisierte-aktionen.rules`
- JavaScript Scripting (`rules-js/`): `aufgeschobene-automatisierte-aktionen-example.js`, `aufgeschobene-automatisierte-aktionen.js`, `lib`
- Python 3 Scripting (`rules-python/`): `aufgeschobene_automatisierte_aktionen.py`, `aufgeschobene_automatisierte_aktionen_example.py`, `deferred.py`
